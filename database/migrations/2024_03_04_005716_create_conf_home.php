...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('conf_homes', function (Blueprint $table) {
            ...
            $table->json('sec_2_sidebar')->default('[{"label":"Data Perizinan","link":"#"},{"label":"Standar Kepuasan Masyarakat","link":null},{"label":"Portal Kabupaten","link":"https:\/\/bangka.go.id"}]');
            ...
            $table->json('sec_3_data')->nullable()->default('[{"icon":"flaticon-running-man","value":"39","satuan":"rb","desc":"Total Masyarakat"},{"icon":"flaticon-coverage","value":"33","satuan":"km","desc":"Cakupan Area"},{"icon":"flaticon-landscape","value":"100","satuan":"%","desc":"Legalitas"},{"icon":"flaticon-barn-3","value":"100","satuan":"%","desc":"Gratis Biaya"}]');
            ...
            $table->json('sec_4_list')->default('["poin 1","poin 2","poin 3"]');
