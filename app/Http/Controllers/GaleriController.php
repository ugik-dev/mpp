        ...
        if ($request->ajax()) {
            ...
            return  DataTables::of($data)->addColumn('id', function ($data) {
                ...
                ->addColumn('link_span', function ($data) {
                    ...
                    return '<img class="thumb-image" style="max-width: 200px; ' . ($data->bg_color ? 'background-color: ' . $data->bg_color . ';' : '') . '" src="' . url('/storage/upload/gallery') . '/' . $data->image . '" alt="' . $data->image . '" />';
