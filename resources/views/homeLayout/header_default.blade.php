                    ...
                    <ul class="main-menu-list list-unstyled">
                        @foreach ($menus as $menu)
                            ...
                            @endphp <li class="{{ $children ? 'has-dropdown' : '' }} "
                                ...
                                <a
                                    href="{{ $menu->jenis == 'route' ? route($menu->slug) : ($menu->jenis == 'N' ? '#' : ($menu->jenis == 'pages' ? $menu->slug : ($menu->jenis == 'link' ? '#' : '#'))) }}">{{ $menu->name }}</a>
                                @if ($children)
                                                        ...
                                                        @foreach ($ch->children as $ch2)
                                                            @php
                                                                if ($ch2->jenis == 'link') {
                                                                    ...
                                                                    if ($menu->jenis == 'route') {
                                                                        $ch2_link = route($menu->slug, ['slug2' => $ch->slug, 'slug3' => $ch2->slug]);
                                                                    } else {
                                                                        $ch2_link = url($menu->slug . '/' . $ch->slug . '/' . $ch2->slug);
                                                                    }
                                                                } elseif ($ch2->jenis == 'N') {
                                                                    $ch2_link = '#';
                                                                } else {
