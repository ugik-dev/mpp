...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Management Gallery dan Banner</h1>
        </div>
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <button id="addBtn" class="btn btn-secondary btn-icon-split font-weight-bold float-end">
                    ...
                    <span class="text">Tambah Gallery dan Banner</span>
                </button>
            </div>
            <div class="card-body">
            ...
            <div class="modal-content">
                <form class="" id="form-bank-data" novalidate="novalidate">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-sm-12 mb-3">
                            <label for="basicFullname" class="form-label">Album :</label>
                            <select type="text" id="album_id" class="form-control" name="album_id">
                                <option value="">-</option>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" id="link" class="form-control" name="link"
                                placeholder="contoh : https://www.youtube.com/watch?v=J_77mw4IMHk&t=9s">
                            <div class="invalid-feedback">
                            </div>
                        </div>
                        <div class="col-sm-12 mb-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            var PatnerForm = {
                ...
                'album_id': $('#form-bank-data').find('#album_id'),
            ...
            datatable.on('click', '.edit-btn', (ev) => {
                ...
                PatnerForm.album_id.val(currentData['album_id']);
            })
            PatnerForm.jenis.on('change', function() {
                if (PatnerForm.jenis.val() == 'img')
                    PatnerForm.link.prop('disabled', true)
                else
                    PatnerForm.link.prop('disabled', false)
            })
            $.ajaxSetup({
                headers: {
            ...
            datatable.on('click', '.delete-btn', function(ev) {
                ...
                Swal.fire(SwalOpt('Konfirmasi hapus ?', 'Data ini akan dihapus!', )).then((result) => {
                    ...
                    $.ajax({
                        url: "<?= route('manage.galeri.delete') ?>/",
                        'type': 'DELETE',
                        data: {
                            '_token': token,
                            'id': id
            ...
            PatnerForm.form.on('submit', function(event) {
                ...
                if (PatnerForm.insertBtn.is(":visible")) {
                    url = '{{ route('manage.galeri.create') }}';
                    metode = 'POST';
                } else {
                    url = '{{ route('manage.galeri.update') }}';
                    metode = 'POST';
                }
