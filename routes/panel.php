...
Route::middleware(['auth', 'checkRole:admin,super'])->group(function () {
    ...
    Route::post('/panel/monitoring/toggle-public-visibility-survey', [MonitoringController::class, 'toggleShowPublic'])->name('panel.monitoring.toggle-public-visibility-survey');
